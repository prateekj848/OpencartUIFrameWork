    ...
    stages 
    {
        ...
        stage('Regression Automation Tests') {
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    ...
                    bat "mvn clean test -DtestSuite=src/test/resources/testrunners/testng_regression.xml"
        ...
        stage('Sanity Automation Test') {
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    git 'https://github.com/prateekj848/OpencartUIFrameWork.git'
                    bat "mvn clean test -DtestSuite=src/test/resources/testrunners/testng_sanity.xml"
